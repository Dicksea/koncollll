...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/mans.jpg'), 2022, "Ariel Kece ~ Multi Device", "6283155687629@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
const fakey = (teks) => {
            mans.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `Join Ngab`,"body": `Join Bot`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/ArielGanteng.jpg`),"sourceUrl": "https://chat.whatsapp.com/IWtWyNsl2wf5kjA8giq6FL"}}}, { quoted: m})
        }
const ftextt = {
key: { 
fromMe: false,
...
*_Bot masih dalam pengembangan_*\n*_Mohon dimaklumi jika terdapat Error_*                 
...
case 'prp': case 'inventori': case 'profile':{
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     let butRun = [
        	{ urlButton: { displayText: `Group WhatsApp`, url : `https://chat.whatsapp.com/IWtWyNsl2wf5kjA8giq6FL` } },
        	{ urlButton: { displayText: `Instagram`, url : `https://Instagram.com/sainnnaaaaii16` } },
            { urlButton: { displayText: `☎️Contact Me`, url: `wa.me/62895364443072` } },
            { quickReplyButton: { displayText: `🏧 leaderboard`, id: 'leaderboard'} }
        	]
        	mans.sendMessage(m.chat, { caption: teksehmazeh, document: { url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx' }, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: 'Fikry FA', templateButtons: butRun, footer: `ingin Berpetualang Lagi`, mentions: [m.sender] })
        	}
        	break
...
case 'list': case 'menu': case 'help': case '?': {
                let kontol = [{
                                urlButton: {
                                    displayText: '📫𝐃𝐨𝐧𝐚𝐬𝐢 𝐊𝐚𝐤',
                                    url: 'https://saweria.co/DixieBot'
                                }
                            }, {
                                urlButton: {
                                    displayText: '💌𝐈𝐧𝐬𝐭𝐚𝐠𝐫𝐚𝐦',
                                    url: 'https://Instagram.com/sainnnaaaaii16'
                                }
                            },{
                                quickReplyButton: {
                                    displayText: '⚡𝐒𝐩𝐞𝐞𝐝',
...
mans.send5ButImg(m.chat, listmn, `Bot Suka Turu`, global.thumb, kontol)
}
        	break
case 'grupbot':
case 'groupbot':
case 'botgrup':
fakey(`https://chat.whatsapp.com/IWtWyNsl2wf5kjA8giq6FL`)
break
case 'limit':
...
[ *MINAT CHAT* ]
wa.me/62895364443072?text=sewa+bot

[ *TES BOT? CHAT NOMER DI BAWAH* ]
Wa.me/62895364443072
...
if (isBan) return m.reply(mess.ban)
if (!args.join(" ")) return m.reply(`Example : \n${prefix + command} ip|port\nUses : \n${prefix + command} play.aespibotz.asp|19132`)
...
"thumbnailUrl": thum,
"thumbnail": thum,
"sourceUrl": "https://youtube.com/watch?v=ALZHF5UqnU4"
...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/mans.jpg'), 2022, "Ariel Kece ~ Multi Device", "6283155687629@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await mans.groupAcceptInvite(vcc).then(async(res) => m.reply(jsonformat(res))).catch(_ => _)
m.reply("Succes")
} else {
...
case 'nulis': {
if (isBan) return m.reply(mess.ban)
if (args.length < 1) return m.reply(`Example :\n${prefix}nulis hai|91|#ff020a|Manusia terganteng adalah Fikry FA`)
const nls = args.join(" ")
...
thumbnail: log0,
mediaType:2,
mediaUrl: "https://youtube.com/watch?v=ALZHF5UqnU4",
sourceUrl: "https://youtube.com/watch?v=ALZHF5UqnU4"
}}
}
mans.sendMessage(m.chat, buttonMessage, { quoted: m })
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Fikry FA - Twitter Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Fikry FA - Facebook Downloader",
...
case 'iqra': {
		...
		mans.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf Ariel Kece`}, {quoted:m}).catch ((err) => m.reply(oh))
		}
		break
		case 'juzamma': {
		if (args[0] === 'pdf') {
...
case 'ytmp3':
  ...
  if (args.length < 1) return reply('linknya?')
     m.reply(`*Tunggu...Jika ada pertanyaan silahkan hubungi Owner*`)
   try{
    await yta(args[0])
.then((res) => {
     const { dl_link } = res
...
mans.sendMessage("62895364443072@s.whatsapp.net", util.format(err), {quoted:m})
console.log(err)
}
}
